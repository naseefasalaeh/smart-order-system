...
export default async function AddonsPage({ searchParams }: { searchParams: Promise<{ q?: string; category?: string; status?: string }> }) {
  ...
  return <main className="min-h-screen bg-orange-50 text-zinc-900 lg:flex"><DashboardSidebar role={role} fullName={fullName} activePath="/dashboard/addons" /><div className="min-w-0 flex-1 px-5 py-10"><div className="mx-auto max-w-3xl">
